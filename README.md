...
## Deploying main site
The CI for this repo is not automatically connected to anything. To deploy, build the [Jenkins job](https://jenkins.ddops.cool/job/gitbook/) and select the appropriate branch.
The `master` branch will deploy to https://developer-test.dronedeploy.com and the `prod` branch will deploy to https://developer.dronedeploy.com
